...
public class LdapAgent {
    ...
    // The field used for RDN attribute csoAgencyNumber.
    @LDAPField(attribute = "csoAgencyNumber",
            objectClass = "csoAgent",
            filterUsage = FilterUsage.ALWAYS_ALLOWED,
            requiredForEncode = true)
    private Long[] csoAgencyNumber;
    ...
    // The field used for attribute homePhone
    ...
    @LDAPField(attribute = "mail",
            ...
            filterUsage = FilterUsage.CONDITIONALLY_ALLOWED)
    private String[] mail;
    // The field used for optional attribute csoAgencyName.
    @LDAPField(attribute = "csoAgencyName",
            objectClass = "csoAgent",
            filterUsage = FilterUsage.CONDITIONALLY_ALLOWED)
    private String[] csoAgencyName;
   ...
   // The field used for optional attribute csoAccountLocked.
    ...
    // The field used for optional attribute csoPassChgExpirDate.
    @LDAPField(attribute="csoPassChgExpirDate",
               objectClass={ "csoAgent",
                             "csoPerson" },
               filterUsage=FilterUsage.CONDITIONALLY_ALLOWED)
    private Date csoPassChgExpirDate;
    ...
    /**
     * Creates a new LdapAgent object decoded from the provided entry.
     *
     * @param entry The entry to be decoded.
     *
     * @return The decoded LdapAgent object.
     *
     * @throws LDAPPersistException If a problem occurs while attempting to
     * decode the provided entry.
     */
    public static LdapAgent decode(final Entry entry)
     ...
     */
    public static LDAPPersister<LdapAgent> getPersister()
            throws LDAPPersistException {
        return LDAPPersister.getInstance(LdapAgent.class);
    }
     ...
     * csoAgencyNumber attribute, if present.
     *
     * @return The first value for the field associated with the csoAgencyNumber
     * attribute, or {@code null} if that attribute was not present in the entry
     * or does not have any values.
     */
    public Long getFirstCsoAgencyNumber() {
        if ((csoAgencyNumber == null)
                || (csoAgencyNumber.length == 0)) {
            return null;
        } else {
            return csoAgencyNumber[0];
        }
    }
    ...
    /**
     * Retrieves the values for the field associated with the csoAgencyNumber
     * attribute, if present.
     *
     * @return The values for the field associated with the csoAgencyNumber
     * attribute, or {@code null} if that attribute was not present in the
     * entry.
     */
    public Long[] getCsoAgencyNumber() {
        return csoAgencyNumber;
    }

    /**
     * Sets the values for the field associated with the csoAgencyNumber
     * attribute.
     *
     * @param v The values for the field associated with the csoAgencyNumber
     * attribute.
     */
    public void setCsoAgencyNumber(final Long... v) {
        this.csoAgencyNumber = v;
    }

    /**
     * Generates a filter that may be used to search for objects of this type
     * using the csoAgencyNumber attribute. The resulting filter may be combined
     ...
     */
    public static Filter generateCsoAgencyNumberFilter(
        ...
        if (filterType == PersistFilterType.PRESENCE) {
            ...
            valueBytes = objectEncoder.encodeFieldValue(fieldInfo.getField(),
                    new Long[]{value},
                    "csoAgencyNumber").getValueByteArray();
        }
    ...
    /**
     * Retrieves the first value for the field associated with the csoAgencyName
     * attribute, if present.
     *
     * @return The first value for the field associated with the csoAgencyName
     * attribute, or {@code null} if that attribute was not present in the entry
     * or does not have any values.
     */
    public String getFirstCsoAgencyName() {
        if ((csoAgencyName == null)
                || (csoAgencyName.length == 0)) {
            return null;
        } else {
            return csoAgencyName[0];
        }
    }

    /**
     * Retrieves the values for the field associated with the csoAgencyName
     * attribute, if present.
     *
     * @return The values for the field associated with the csoAgencyName
     * attribute, or {@code null} if that attribute was not present in the
     * entry.
     */
    public String[] getCsoAgencyName() {
        return csoAgencyName;
    }

    /**
     * Sets the values for the field associated with the csoAgencyName
     * attribute.
     *
     * @param v The values for the field associated with the csoAgencyName
     * attribute.
     */
    public void setCsoAgencyName(final String... v) {
        this.csoAgencyName = v;
    }

    /**
     * Generates a filter that may be used to search for objects of this type
     * using the csoAgencyName attribute. The resulting filter may be combined
     * with other filter elements to create a more complex filter.
     *
     * @param filterType The type of filter to generate.
     * @param value The value to use to use for the filter. It may be
     ...
     * to generate the filter.
     */
    public static Filter generateCsoAgencyNameFilter(
            final PersistFilterType filterType,
            final String value)
            throws LDAPPersistException {
        final byte[] valueBytes;
        if (filterType == PersistFilterType.PRESENCE) {
            ...
            valueBytes = objectEncoder.encodeFieldValue(fieldInfo.getField(),
                    new String[]{value},
                    "csoAgencyName").getValueByteArray();
        }
         ...
         throws LDAPPersistException
  {
    ...
    switch (filterType)
    {
      ...
      /**
   * Retrieves the value for the field associated with the
   * csoPassChgExpirDate attribute, if present.
   *
   * @return  The value for the field associated with the
   *          csoPassChgExpirDate attribute, or
   *          {@code null} if the field does not have a value.
   */
  public Date getCsoPassChgExpirDate()
  {
    return csoPassChgExpirDate;
  }
  ...
  /**
   * Sets the value for the field associated with the
   * csoPassChgExpirDate attribute.
   *
   * @param  v  The value for the field associated with the
   *            csoPassChgExpirDate attribute.
   */
  public void setCsoPassChgExpirDate(final Date v)
  {
    this.csoPassChgExpirDate = v;
  }
  ...
  /**
   * Generates a filter that may be used to search for objects of this type
   * using the csoPassChgExpirDate attribute.
   * The resulting filter may be combined with other filter elements to create a
   * more complex filter.
   *
   * @param  filterType  The type of filter to generate.
   ...
   *                                to generate the filter.
   */
  public static Filter generateCsoPassChgExpirDateFilter(
                            final PersistFilterType filterType,
                            final Date value)
         throws LDAPPersistException
  {
    ...
    else
    {
      ...
      valueBytes = objectEncoder.encodeFieldValue(fieldInfo.getField(),
           value,
           "csoPassChgExpirDate").getValueByteArray();
    }
    ...
    /**
     * Retrieves a string representation of this {@code LdapAgent} object.
     *
     * @return A string representation of this {@code LdapAgent} object.
     */
    @Override()
    ...
    /**
     * Appends a string representation of this {@code LdapAgent} object to the
     * provided buffer.
     *
    ...
    public void toString(final StringBuilder buffer) {
        ...
        if (csoAgencyNumber != null) {
            ...
            appended = true;
            buffer.append("csoAgencyNumber=");
            buffer.append(Arrays.toString(csoAgencyNumber));
        }
        ...
        if (csoAgencyName != null) {
            ...
            appended = true;
            buffer.append("csoAgencyName=");
            buffer.append(Arrays.toString(csoAgencyName));
        }
    ...
    /**
     * CSO Specific: translate the LDAP Agent into a CSO Portal Agent
     */
    public static Agent translateLdapIntoAgent(LdapAgent lda)
            throws UserCreationException {
        String dt = lda.getFirstCsoLastLogin();
        Date date = null;
        if (dt != null) {
            ...
            try {
                ...
                StringBuilder sb = new StringBuilder("unable to parse last login date")
                        .append(" for user ").append(lda.getUid());
                throw new UserCreationException(sb.toString(), e);
            }
        }

        boolean lock = false;
        if (lda.getCsoAccountLocked() != null) {
            lock = lda.getCsoAccountLocked();
        }
        return new Agent(lda.getFirstUid(), lda.getFirstGivenName(),
                lda.getFirstSn(), lda.getFirstMail(), lda.getFirstHomePhone(),
                lda.getFirstCsoChallengeQuestion(), lda.getFirstCsoChallengeAnswer(),
                date,
                lda.getFirstCsoAgencyNumber(), lda.getFirstCsoAgencyName(),
                lock);
    }

    public static LdapAgent updateLdapAgent(LdapAgent lda, Agent agent) {
        lda.setUid(agent.getLogin());
        lda.setGivenname(agent.getFirstName());
        lda.setSn(agent.getLastName());
        String[] email = {agent.getEmail()};
        lda.setMail(email);
        String[] phone = {agent.getPhone()};
        lda.setHomePhone(phone);
        lda.setCsoChallengeQuestion(agent.getChallengeQuestion());
        lda.setCsoChallengeAnswer(agent.getChallengeAnswer());

        SimpleDateFormat fmt = new SimpleDateFormat(Constant.dateFormat);
        String lastLogin = fmt.format(agent.getLastLogin());
        lda.setCsoLastLogin(lastLogin);
        lda.setCsoAgencyNumber(agent.getAgencyNumber());
        lda.setCsoAgencyName(agent.getAgencyName());

        return lda;
    }

    public static LdapAgent translateRegInfoIntoAgent(RegistrationInfo info) {
        return new LdapAgent(info.getUserName(), info.getFirstName(), info.getLastName(),
                info.getEmail(), info.getPhoneNumber(), info.getChallengeQuestion(),
                info.getChallengeAnswer(), info.getAgentAgencyNumber(), info.getAgentAgencyName(),
                info.getPassword());

    }

    public LdapAgent(String uid, String firstName,
            String lastName, String email, String phone, String challengeQuestion,
            String challengeAnswer, String agencyNumber, String agencyName,
            String password) {
        ...
        Long[] anum = {Long.valueOf(agencyNumber)};
        this.csoAgencyNumber = anum;
        String[] aname = {agencyName};
        this.csoAgencyName = aname;
