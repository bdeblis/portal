...
//  private String[] givenName;
  ...
  public LdapCashier()
  {
    ...
    public String getFirstCsoLastLogin() {
     ...
     public LdapCashier(String uid, String firstName,
       ...
       public static Cashier translateLdapIntoCashier(LdapCashier ldPh)
        ...
        return new Cashier(ldPh.getFirstUid(), ldPh.getFirstGivenName(),
  ...
  /**
   * Creates a new LdapCashier object decoded
   * from the provided entry.
   *
   * @param  entry  The entry to be decoded.
   *
   * @return  The decoded LdapCashier object.
   *
   * @throws  LDAPPersistException  If a problem occurs while attempting to
   *                                decode the provided entry.
   */
  public static LdapCashier decode(final Entry entry)
         throws LDAPPersistException
  {
    return getPersister().decode(entry);
  }
  
  	public static LdapCashier translateRegInfoIntoCashier(RegistrationInfo info) {
        return new LdapCashier(info.getUserName(), info.getFirstName(), info.getLastName(),
    ...
    public static LdapCashier updateLdapCashier(LdapCashier ldPh, Cashier ph) {
 ...
 /**
   ...
   */
  public static LDAPPersister<LdapCashier> getPersister()
         throws LDAPPersistException
  {
    return LDAPPersister.getInstance(LdapCashier.class);
  }
   ...
   *            audio attribute.
   */
  public void setAudio(final String... v)
  {
    this.audio = v;
  }
   ...
   *            photo attribute.
   */
  public void setPhoto(final String... v)
  {
    this.photo = v;
  }
