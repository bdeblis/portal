...
@LDAPObject(structuralClass = "organizationalPerson",
        auxiliaryClass = {"csoPerson",
            "inetOrgPerson"},
        superiorClass = {"csoExtension",
    "person",
    "top"},
...
public class LdapPerson {
  ...
  // The field used for optional attribute csoPassChgExpirDate.
    ...
    /**
     * Creates a new LdapPerson object decoded from the provided entry.
     *
     * @param entry The entry to be decoded.
     *
     * @return The decoded LdapPerson object.
     *
     * @throws LDAPPersistException If a problem occurs while attempting to
     * decode the provided entry.
     */
    public static LdapPerson decode(final Entry entry)
     ...
     */
    public static LDAPPersister<LdapPerson> getPersister()
            throws LDAPPersistException {
        return LDAPPersister.getInstance(LdapPerson.class);
    }
     ...
     *
     * @return The first value for the field associated with the
     * csoPassChgSecurityToken attribute, or {@code null} if that attribute was
         ...
         throws LDAPPersistException
  {
    ...
    /**
     * Retrieves a string representation of this {@code LdapPerson} object.
     *
     * @return A string representation of this {@code LdapPerson} object.
     */
    @Override()
    ...
    /**
     * Appends a string representation of this {@code LdapPerson} object to the
     * provided buffer.
     *
