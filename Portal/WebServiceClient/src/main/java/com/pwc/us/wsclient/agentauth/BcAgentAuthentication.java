...
import com.pwc.us.ws.client.agentauth.bc.Authentication;
import com.pwc.us.ws.client.agentauth.bc.Locale;
import com.pwc.us.ws.client.agentauth.bc.PortalSecurityAPIPortType;
import com.pwc.us.ws.client.agentauth.bc.RegistrationNotCompleteException_Exception;
import com.pwc.us.ws.client.agentauth.bc.UserAuthTypeInvalidException_Exception;
import com.pwc.us.ws.client.agentauth.bc.UserNotActiveException_Exception;
import com.pwc.us.ws.client.agentauth.bc.UserNotFoundException_Exception;
 ...
 * @author Roger
 */
public class BcAgentAuthentication {
    
    private static String WSDL = JndiUtils.getBillingCenterUrl() + "/ws/compsource/bc/api/portalauth/PortalSecurityAPI?WSDL";
    private static String SVC_QNAME_NAMESPACE_URI = "http://example.com/compsource/bc/api/portalauth/PortalSecurityAPI";
    private static String SVC_QNAME_LOCALPART = "PortalSecurityAPI";
    private static String PORT_QNAME_NAMESPACE_URI = "http://example.com/compsource/bc/api/portalauth/PortalSecurityAPI";
    ...
    public String isAgentActive(String userName)
            throws GwIntegrationException, GwUserNotFoundInBcException {
        ...
        try {
        ...
        } catch (com.pwc.us.ws.client.agentauth.bc.SOAPException_Exception e) {
            ...
            logger.error(msg, e);
            throw new GwUserNotFoundInBcException(msg, e);
        }
        return ret;
    }
        ...
        if (port == null) {
            try {
                ...
                throw new GwIntegrationException(
                        "unable to create agent authentication web service for class PortalSecurityAPIPortType (in BC)", e);

            } catch (MalformedURLException e) {
                logger.error("Malformed URL creating agent authentication web service for class PortalSecurityAPIPortType (in BC)");
                throw new GwIntegrationException("malformed URL while creating "
                        + "agent authentication web service for class PortalSecurityAPIPortType (in BC)", e);
            }
        }
    }    
