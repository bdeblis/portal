...
scp WebStripes/target/compsource-portal-webui-stripes.war root@gwportale2e.s-i-f.local:/usr/share/tomcat6/webapps/gwportale2e.s-i-f.local/ROOT.war

scp Tomcat_JNDI_Context_Files/E2E/compsource-portal-webui-stripes.xml root@gwportale2e.s-i-f.local:/usr/share/tomcat6/conf/Catalina/gwportale2e.s-i-f.local/ROOT.xml
